    ...
    <AnimatePresence mode="wait">
      ...
      >
        {/* <button className="border text-sm font-medium relative border-neutral-200 dark:border-white/[0.2] text-black dark:text-white px-4 py-2 rounded-full"> */}
          ...
          >Home</Link>
        {/* </button> */}
          <span className="absolute inset-x-10 w-1/2 mx-auto -bottom-px bg-gradient-to-r from-transparent via-slate-50 to-transparent h-px" /> 
        {navItems.map((navItem: any, idx: number) => (
          ...
          >
            ...
            <span className="hidden sm:block text-sx">{navItem.name}</span>
          </Link>
        ))}
        <p></p>
        <span></span>
